...
> Portfolio in, risk report out — three VaR methods reported side by side, risk attributed by Euler decomposition, and findings surfaced without being asked for.
...
The market is synthetic — a factor model with fat tails and a crash regime, generated by src/demo.py. The service is real and the numbers are computed, but no market data and no client portfolio is involved.

Last run: `2026-08-31T19:23:12+00:00`
...
```bash
cp -r website/ ../my-4-risk-portfolio-saas-site && cd ../my-4-risk-portfolio-saas-site
